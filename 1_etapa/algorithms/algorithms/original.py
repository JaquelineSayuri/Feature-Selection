...
# colon_cancer
train_file_names = [
	'datasets/colon_cancer/colon_cancer(train).csv',
	'datasets/colon_cancer/colon_cancer(train)stand.csv'
]

test_file_names = [
	'datasets/colon_cancer/colon_cancer(test).csv',
	'datasets/colon_cancer/colon_cancer(test)minmax.csv',
	'datasets/colon_cancer/colon_cancer(test)stand.csv'
]


# madelon
train_file_names = [
	'datasets/madelon/madelon(train).csv',
	'datasets/madelon/madelon(train)stand.csv'
]

test_file_names = [
	'datasets/madelon/madelon(test).csv',
	'datasets/madelon/madelon(test)stand.csv'
]
...
# PCMAC
train_file_names = [
	'datasets/PCMAC/PCMAC(train).csv',
	'datasets/PCMAC/PCMAC(train)stand.csv'
]

test_file_names = [
	'datasets/PCMAC/PCMAC(test).csv',
	'datasets/PCMAC/PCMAC(test)stand.csv'
]
'''
